    ...
    <main className="flex flex-col w-full max-w-[1082px] bg-background rounded-[16px] p-10 min-h-[584px]">
      ...
      <div className="flex gap-3 border-b border-border pb-6 mb-6 w-full">
        <label className="flex flex-1 flex-col gap-2">
          ...
          <input
            type="text"
            className="w-full h-12 px-4 rounded-lg border border-input bg-transparent outline-none focus:border-ring transition-colors text-sm text-foreground"
        ...
        <button 
          ...
          className="bg-primary text-primary-foreground size-12 rounded-lg flex items-center justify-center hover:bg-primary/90 transition-colors mt-[22px] shrink-0"
        >
          ...
          data?.data.map((refund) => (
            ...
            >
              <div className="flex items-center gap-3">
                <div className="bg-secondary p-[8px] rounded-full text-foreground">
      ...
      {data?.meta && data.meta.lastPage > 1 && (
        <div className="flex items-center justify-center gap-2 mt-auto pt-8">
          <button
            ...
            className="size-8 rounded-lg bg-primary text-primary-foreground flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed hover:bg-primary/90 transition-colors"
          >
